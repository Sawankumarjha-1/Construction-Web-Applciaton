...
<head>
  ...
  <title>Jhaji Construction | Edit Project</title>
            ...
            <div class="card card-primary">
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="card-body">
                      ...
                      <?php 
                        ...
                        if(mysqli_num_rows($categ)){
                          ...
                          while($categ_data=mysqli_fetch_assoc($categ)){
                            ...
                            ?>
                            <option value="<?php echo $categ_data['category_name'];?>" <?php echo $projectData['category']==$categ_data['category_name']?"selected":"";?>><?php echo $categ_data['category_name'];?></option>
                            <?php
                          }
                  ...
                  <div class="form-group">
                    <label for="">Images ( <?php echo $projectData['image'];?>)</label>
                    <input type="file" class="form-control" id="" name="image[]" style="border:none;" multiple>
                  </div>
                  <div class="form-group">
                  <label for="">Description</label>
                  <textarea name="detail" class="form-control"  placeholder="Description" required><?php echo $projectData['detail'];?></textarea>
                  </div>
                </div>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="submit" class="btn btn-danger" name="update_project">Update Project</button>
                </div>
              </form>
              <?php 
                if(isset($_POST['update_project'])){
                  ...
                  $detail=$_POST['detail'];
                    ...
                    if($check!=''){
                        ...
                        echo $boat_img;
                        $ins_pro=mysqli_query($conn,"UPDATE `projects` SET `project_name`='$project_name',`category`='$category',`image`='$boat_img',`detail`='$detail' WHERE id=$updateId");
                        
                    }else{
                        $ins_pro=mysqli_query($conn,"UPDATE `projects` SET `project_name`='$project_name',`category`='$category',`detail`='$detail' WHERE id=$updateId");
                    }
