...
<head>
  ...
  <title>Jhaji Construction | Update Team Member</title>
            ...
            <div class="card card-primary">
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="">Images ( <?php echo $teamData['image'];?> )</label>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-danger" name="update_team">Update Team Member</button>
                </div>
              </form>
              <?php 
