...
<head>
  ...
  <title>Jhaji Construction | Contact Lists</title>
                    ...
                    if(mysqli_num_rows($contact_res)){
                        while($contact_data=mysqli_fetch_assoc($contact_res)){
                            ...
                            <tr>
                                ...
                                <td style="width:15%;">
                                    <a href="contact.php?deleteId=<?php echo $contact_data['id'];?>" onclick="return confirm('Do you want to delete ?');"class="btn btn-danger" title="Delete"><i class="fa fa-trash" aria-hidden="true" style="color:#ffffff; margin:2px;"></i></a>
